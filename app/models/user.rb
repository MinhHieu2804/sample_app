class User < ApplicationRecord
  ...
  class << self
    def digest string
      bcost = BCrypt::Engine.cost
      bmincost = BCrypt::Engine::MIN_COST
      cost = ActiveModel::SecurePassword.min_cost ? bmincost : bcost
  ...
  def feed
    microposts.by_user_ids(following_ids << id).latest
  end
